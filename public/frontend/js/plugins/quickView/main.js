jQuery(document).ready(function($){
	...
	//maxQuickWidth --> this is the max-width of the quickView panel
	...
	$('.trigger-quick-view').on('click', function(event){
		...
		//custom...
		//update the slider selected image
		$('#selected-image').attr('src', slectedImageUrl)
	...
	function animateQuickView(image, finalWidth, maxQuickWidth, animationType) {
		...
		var parentListItem = image.parents(':eq(4)'),
