    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            ...
            <div class="ibox-content">
                ...
                <form method="POST" action="{{ route('admin.sliders.update', $slider->id) }}" enctype="multipart/form-data" class="form-horizontal">
                    {{method_field('PUT')}}
                    @csrf()
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <a href="{{ route('admin.sliders.index') }}" class="btn btn-sm btn-warning t m-t-n-xs"><strong>Cancel</strong></a>
